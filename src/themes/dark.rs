...
pub fn gene_dark(name: &str, rank: &str, rating: i64, avatar: &RgbaImage) -> RgbaImage {
    let mut ret = RgbaImage::from_pixel(518, 320, Rgba([0x0e, 0x0e, 0x0e, 255]));
...
pub fn fail_dark(msg: &str) -> RgbaImage {
    let mut ret = RgbaImage::from_pixel(518, 320, Rgba([0x0e, 0x0e, 0x0e, 255]));
